...
| **4** | Unify LFOs; Screen UART; drop redundant forwards |
| **5** | Remove Mainboard link; three-board overview; archive Mainboard |
...
## Open before Phase 3 (hardware bring-up)

1. Confirm physical carrier exposes GP29 (RESET OSC1) or remap RESET/RANGE.
2. Measure PW vs CV PWM if any slice sharing is reintroduced.
